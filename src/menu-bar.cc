...
MenuBar::MenuBar (QWidget *parent) : QMenuBar (parent)
{
  ...
  connect (view_documentation_action, &QAction::triggered, this, &MenuBar::on_view_documentation_selected);
  connect (report_an_issue_action, &QAction::triggered, this, &MenuBar::on_report_an_issue_selected);
...
void
MenuBar::add_effect (const QString& effect_name)
{
...
void
MenuBar::on_quit_selected (void)
{
  emit quit_selected ();
}

void
MenuBar::on_effect_selected (const QString& effect_name)
{
  emit effect_selected (effect_name);
}

void
MenuBar::on_view_documentation_selected (void)
{
  doc_browser->show ();
}

void
MenuBar::on_report_an_issue_selected (void)
{
  QDesktopServices::openUrl (QUrl (GNUITAR_ISSUES_LINK));
}

void
MenuBar::on_about_selected (void)
{
