...
void
MainWindow::add_effect (EffectView *effect_view)
{
  rack->add_effect (effect_view);
}

void
MainWindow::add_effect_choice (const QString& effect_name)
{
...
void
MainWindow::on_effect_changed (const QString& effect_name, const QString& control_name, int control_value)
{
