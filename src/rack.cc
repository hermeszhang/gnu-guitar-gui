...
Rack::add_effect (EffectView *effect_view)
{
  ...
  auto effect_callback = [this, effect_view] (const QString& control_name, int control_value) {
...
void
Rack::on_effect_changed (const QString& effect_name, const QString& control_name, int control_value)
{
