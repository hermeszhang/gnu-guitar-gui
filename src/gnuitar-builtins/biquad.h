...
#ifndef GNUITAR_BIQUAD_H
#define GNUITAR_BIQUAD_H
...
struct GnuitarHilbert {
    struct GnuitarBiquad a1[MAX_CHANNELS];
    struct GnuitarBiquad a2[MAX_CHANNELS];
    double x0_tmp[MAX_CHANNELS];
};
...
void gnuitar_biquad_set_peq(const double Fs, const double Fc, const double BW, const double G, struct GnuitarBiquad *f);
void gnuitar_biquad_set_bpf(const double Fs, const double Fc, const double BW, struct GnuitarBiquad *f);
void gnuitar_biquad_set_lpf(const double Fs, const double Fc, const double BW, struct GnuitarBiquad *f);
void gnuitar_biquad_set_phaser(const double delay, struct GnuitarBiquad *f);
void gnuitar_biquad_set_2nd_allpass(const double delay, struct GnuitarBiquad *f);
void gnuitar_biquad_set_rc_lowpass(const double Fs, const double Fc, struct GnuitarBiquad *f);
...
void gnuitar_fir_interpolate_2x(double *mem, const double in, double *o1, double *o2);
double gnuitar_fir_decimate_2x(double *mem, const double in1, const double in2);
